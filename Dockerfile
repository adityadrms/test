...
LABEL com.vmware.cp.artifact.flavor="sha256:c50c90cfd9d12b445b011e6ad529f1ad3daea45c26d20b00732fae3cd71f6a83" \
      ...
      org.opencontainers.image.created="2024-12-13T09:38:17Z" \
      ...
      org.opencontainers.image.ref.name="3.9.0-debian-12-r4" \
...
RUN apt-get update && apt-get install -y --no-install-recommends ca-certificates curl procps zlib1g && \
...
RUN mkdir -p /tmp/bitnami/pkg/cache/ ; cd /tmp/bitnami/pkg/cache/ ; \
    COMPONENTS=( \
      ...
      "kafka-3.9.0-1-linux-${OS_ARCH}-debian-12" \
    ) ; \
...
RUN apt-get update && apt-get install -y dos2unix && \
    dos2unix /opt/bitnami/scripts/java/postunpack.sh && \
    dos2unix /opt/bitnami/scripts/kafka/postunpack.sh
